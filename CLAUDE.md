...
- `docs/ai-delivery/project-rules.md` — 项目级禁止模式和架构约束
- `docs/ai-delivery/risk-playbooks/{tag}.md` — 对应风险标签的 playbook（从需求文档的风险标签 section 获取 tag 列表）

运行 `npm run ai:next -- <feature-slug>` 获取当前阶段 prompt 和所有上下文。
<!-- /ai-delivery-kit -->

<!-- ai-delivery-kit-triggers:start -->
