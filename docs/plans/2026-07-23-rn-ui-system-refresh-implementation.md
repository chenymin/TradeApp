...
- 需求：`docs/requirements/2026-07-23-rn-ui-system-refresh.md`
- 方案：`docs/plans/2026-07-23-rn-ui-system-refresh-design.md`
...
- 预计影响文件：测试修正（仅发现真实缺口时）、`docs/ai-delivery/runs/2026-07-23-rn-ui-system-refresh-verification.md`。
...
```bash
git add docs/ai-delivery/runs/2026-07-23-rn-ui-system-refresh-verification.md
